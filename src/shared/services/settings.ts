...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    {
      name: 'evolink',
      title: t('groups.evolink'),
      description: `Custom <a href="https://docs.evolink.ai/cn/quickstart" class="text-primary" target="_blank">Evolink</a> settings`,
      tab: 'ai',
    },
    {
      name: 'replicate',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      tip: 'OpenAI compatible base URL for Evolink',
      group: 'evolink',
      tab: 'ai',
    },
    {
    ...
    {
      name: 'video_transcriptapi_api_key',
      title: 'TranscriptAPI API Key',
      type: 'password',
      placeholder: 'xxx',
      group: 'video_transcript',
      tab: 'ai',
      tip: 'Primary provider. API key for TranscriptAPI (transcriptapi.com)',
    },
    {
      name: 'video_transcript_api_key',
      title: 'deAPI API Key (Fallback)',
      type: 'password',
      placeholder: 'xxx',
      group: 'video_transcript',
      tab: 'ai',
      tip: 'Fallback provider. Used when TranscriptAPI fails or returns no subtitles',
    },
    {
      name: 'video_transcript_base_url',
      title: 'deAPI Base URL',
      type: 'url',
      placeholder: 'https://api.deapi.ai',
      group: 'video_transcript',
      tab: 'ai',
      tip: 'Base URL for deAPI fallback provider',
    },
    {
      name: 'video_transcript_model',
      title: 'deAPI Model',
      type: 'text',
      placeholder: 'WhisperLargeV3',
      group: 'video_transcript',
      tab: 'ai',
      tip: 'Model for deAPI fallback provider',
    },
    {
    ...
    {
      name: 'video_reasoning_evolink_model',
      title: 'Evolink Chat Model',
      type: 'text',
      placeholder: 'gemini-2.5-flash',
      tip: 'default chat model for follow-up Q&A when video reasoning provider is Evolink',
      group: 'video_reasoning',
      tab: 'ai',
    },
    {
