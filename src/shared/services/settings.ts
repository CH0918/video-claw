...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      title: t('groups.video_transcript'),
      description: 'custom your video transcript provider settings',
      tab: 'ai',
    },
    {
      name: 'video_reasoning',
      title: t('groups.video_reasoning'),
      description: 'custom your video reasoning provider settings',
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'select',
      value: 'deapi',
      options: [{ title: 'deAPI', value: 'deapi' }],
      group: 'video_transcript',
      tab: 'ai',
      tip: 'provider used to convert a YouTube video into transcript',
    },
    {
      name: 'video_transcript_base_url',
      title: 'Transcript Base URL',
      type: 'url',
      placeholder: 'https://api.deapi.ai',
      group: 'video_transcript',
      tab: 'ai',
    },
    {
      name: 'video_transcript_api_key',
      title: 'Transcript API Key',
      type: 'password',
      placeholder: 'xxx',
      group: 'video_transcript',
      tab: 'ai',
    ...
    {
      name: 'video_transcript_model',
      title: 'Transcript Model',
      type: 'text',
      placeholder: 'video-to-text',
      group: 'video_transcript',
      tab: 'ai',
    },
    {
      name: 'video_reasoning_provider',
      title: 'Reasoning Provider',
      type: 'select',
      value: 'deepseek',
      options: [{ title: 'DeepSeek', value: 'deepseek' }],
      group: 'video_reasoning',
      tab: 'ai',
      tip: 'provider used for topic ranges, summary and chat',
    },
    {
      name: 'video_reasoning_base_url',
    ...
    {
      name: 'video_reasoning_api_key',
      title: 'Reasoning API Key',
      type: 'password',
      placeholder: 'xxx',
      group: 'video_reasoning',
      tab: 'ai',
